...
MySQL - 10.4.14-MariaDB : Database - employee-data
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`employee-data` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `employees` (
  ...
  `age` int(11) NOT NULL,
  `hire_date` text COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `exit_date` text COLLATE utf8mb4_unicode_ci NOT NULL,
